...
/**
 * Implementación concreta del almacén persistente en memoria para la gestión de Edificios.
 * Reutiliza las estructuras basadas en colecciones lineales exigidas por las pautas técnicas.
 */
